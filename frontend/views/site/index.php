        ...
        <div class="services_inner">
            ...
            <div class="services_item">
                ...
                <ul>
                    ...
                    <li>
                        Сетка "Антипыльца" (Для аллергиков)
                    </li>
                    <li>
        ...
        <div class="video_inner">
            ...
            <div class="video_info aos-init aos-animate" data-aos="fade-right">
                ...
                <div class="video_content">
                    <p class="text">
                            <span>
                                Контролируем весь процесс
                            </span>
                        от замера проемов до сдачи объекта в эксплуатацию
                    </p>
                </div>
                <div class="video_content">
                    <p class="text">
                        В производстве окон мы используем оконные профили фурнитуру
                        <span>
